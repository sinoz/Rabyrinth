...
public final class UITest extends ApplicationAdapter {
	public static void main(String[] args) {
		new LwjglApplication(new UITest());
	}

	private static final String[] listEntries = {"This is a list entry1", "And another one1", "The meaning of life1", "Is hard to come by1",
	...
	public void create () {
		...
		texture1 = new Texture(Gdx.files.internal("resources/knuckles.png"));
		texture2 = new Texture(Gdx.files.internal("resources/knuckles.png"));
